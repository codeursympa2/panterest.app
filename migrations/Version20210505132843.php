 ...
 */
final class Version20210505132843 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Creation des utilisateur';
    }
         ...
         first_name VARCHAR(255) NOT NULL,
          last_name VARCHAR(255) NOT NULL,
           email VARCHAR(180) NOT NULL,
            roles LONGTEXT NOT NULL COMMENT \'(DC2TYPE:json)\', password VARCHAR(255) NOT NULL,
